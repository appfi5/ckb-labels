...
export const udtSchema = z.object({
  "$schema": z.string(),
  name: z.string().nullable(), // .min(1, { error: "Name is required" }).describe("UDT Name"),
  ...
  udtType: z.enum(["sudt", "xudt", "xudt_compatible", "omiga_inscription", "ssri"]),
  published: z.boolean(),
  email: z.string().nullable(),
  famous: z.boolean(),
  operatorWebsite: z.string().nullable(),
})